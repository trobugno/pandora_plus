...
Pandora+ comes in two editions to fit different needs and budgets. This page explains the differences between the **Core (Free)** and **💎 Premium** editions.
...
| **Quest System** | ✅ Basic Quests | ✅ Full featured |
| **NPC System** | ✅ Basic NPC | ✅ Full featured |
...
- ⭐ Star the [GitHub repository](https://github.com/trobugno/pandora_plus)
- 🐛 Report bugs and contribute fixes
- ☕ Buy me a coffee on [Ko-fi](https://ko-fi.com/trobugno)
- 💎 Upgrade to Premium to support development
